...
class Settings(BaseSettings):
    ...
    feishu_weather_bot_aliases: str | None = None
    feishu_weather_bot_mention_ids: str | None = None
    ...
    feishu_task_bot_aliases: str | None = None
    feishu_task_bot_mention_ids: str | None = None
